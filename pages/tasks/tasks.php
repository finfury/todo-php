...
function getTaskList($date) {
    ...
    $query = "SELECT * FROM " . $tasks . " WHERE `Дедлайн` = $date";
        ...
        <main class="main active-tasks">
            <div class="tasks">
                ...
                while ($count < 5) {
                    ...
                    if ($count % 3 == 0) {
                        $event = '<div class="event-wrapper"> ' . $event . '
                            <div class="event__footer">Keep moving and doing this site</div>
                        </div>';
                    }
                    echo $event;
                    $count++;
